    ...
    return (
        <header className='flex justify-between'>
            ...
            <div className='flex items-center gap-4 border border-gray-300 rounded-full py-2 px-4 shadow-md shadow-gray-300'>
                <div className='font-weight-900 text-md'>Anywhere</div>
                <div className="border-l border-gray-300 h-8" />
                <div className='font-weight-900 text-md'>Any Week</div>
                <div className="border-l border-gray-300 h-8" />
                <div className='font-weight-900 text-md'>Add Guest</div>
            ...
            <Link to={'/login'} className='flex items-center gap-4 border border-gray-300 rounded-full py-2 px-2'>
